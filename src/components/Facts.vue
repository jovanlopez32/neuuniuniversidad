    ...
    <article>
        ...
        <h2>
            <span  class="flex text-slate-900 dark:text-neutral-100 text-5xl font-extrabold mb-2">
                <span :ref="el => numbers.push(el)">100</span> %
            </span>
